...
int semgetvalwrapper(int semid, int semnum) { return semctl(semid, semnum, GETVAL); }
...
int semdestroywrapper(int semid, int semnum) { return semctl(semid, semnum, IPC_RMID); }