...
# cmd
WORKDIR /home/bbs
CMD ["sh", "-c", "sudo -iu bbs /home/bbs/bin/shmctl init && sudo -iu bbs /home/bbs/bin/logind && /usr/bin/openresty && sudo -iu bbs /home/bbs/bin/boardd -l 0.0.0.0:5150 && sudo -iu bbs /srv/go-pttbbs/go-pttbbs -ini production.ini"]
