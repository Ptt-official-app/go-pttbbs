...
var (
	...
	testBoardDetail6 = &ptttype.BoardDetailRaw{
		Bid: 6,
	...
	testBoardDetail7 = &ptttype.BoardDetailRaw{
		Bid: 7,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     5,
			Brdname: ptttype.BoardID_t{0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x00, 0x2e, 0x2e, 0x2e, 0x2e},
	...
	testBoardDetail11 = &ptttype.BoardDetailRaw{
		Bid: 11,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     5,
			Brdname: ptttype.BoardID_t{0x45, 0x64, 0x69, 0x74, 0x45, 0x78, 0x70, 0x00, 0x2e, 0x2e, 0x2e, 0x2e},
	...
	testBoardDetail8 = &ptttype.BoardDetailRaw{
		Bid: 8,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     5,
			Brdname: ptttype.BoardID_t{0x4e, 0x6f, 0x74, 0x65, 0x00, 0x65, 0x64, 0x00, 0x2e, 0x2e, 0x2e, 0x2e},
	...
	testBoardDetail1 = &ptttype.BoardDetailRaw{
		Bid: 1,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     2,
			BrdAttr: ptttype.BRD_POSTMASK,
	...
	testBoardDetail9 = &ptttype.BoardDetailRaw{
		Bid: 9,
	...
	testBoardDetail10 = &ptttype.BoardDetailRaw{
		Bid: 10,
	...
	testBoardDetail12 = &ptttype.BoardDetailRaw{
		Bid: 12,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     5,
			BrdAttr: ptttype.BRD_POSTMASK | ptttype.BRD_HIDE,
			Brdname: ptttype.BoardID_t{'A', 'L', 'L', 'H', 'I', 'D', 'P', 'O', 'S', 'T', 0x00, 0x2e},
			Title: ptttype.BoardTitle_t{
				0xbc, 0x54, 0xad, 0xf9, 0x20, 0xa1, 0xb7, 0xb8, 0xf3, 0xaa,
				0x4f, 0xa6, 0xa1, 0x4c, 0x4f, 0x43, 0x41, 0x4c, 0xb7, 0x73,
				0xa4, 0xe5, 0xb3, 0xb9, 0x28, 0xc1, 0xf4, 0xaa, 0x4f, 0x29,
				0x00, 0x20, 0xa3, 0xad, 0xa1, 0x49, 0x00, 0x6e,
			},
			Level: ptttype.PERM_SYSOP,
		},
	}
	...
	testClassDetail2 = &ptttype.BoardDetailRaw{
		Bid: 2,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     1,
			BrdAttr: ptttype.BRD_GROUPBOARD,
	...
	testClassDetail5 = &ptttype.BoardDetailRaw{
		Bid: 5,
		BoardHeaderRaw: &ptttype.BoardHeaderRaw{
			Gid:     1,
			BrdAttr: ptttype.BRD_GROUPBOARD,
