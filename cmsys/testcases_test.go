...
var (
	...
	testArticleSummary2_d = &ptttype.ArticleSummaryRaw{
		Aid: 2,
		FileHeaderRaw: &ptttype.FileHeaderRaw{
			Filename: ptttype.Filename_t{ // .d1607203395.A.F6C
				'.', 'd', 0x31, 0x36, 0x30, 0x37, 0x32, 0x30,
				0x33, 0x33, 0x39, 0x35, 0x2e, 0x41, 0x2e, 0x30,
				0x30, 0x44,
			},
			Modified: 1607203394,
	...
	testArticleSummary2_d2 = &ptttype.ArticleSummaryRaw{
		Aid: 2,
		FileHeaderRaw: &ptttype.FileHeaderRaw{
			Filename: ptttype.Filename_t{ // .deleted
				'.', 'd', 'e', 'l', 'e', 't', 'e', 'd',
			},
			Modified: 1607203394,
			Owner:    ptttype.Owner_t{0x53, 0x59, 0x53, 0x4f, 0x50}, // SYSOP
	...
	testArticleSummary3_d = &ptttype.ArticleSummaryRaw{
		Aid: 3,
		FileHeaderRaw: &ptttype.FileHeaderRaw{
			Filename: ptttype.Filename_t{ // M.1607203395.A.F6D
				'.', 'd', 0x31, 0x36, 0x30, 0x37, 0x32, 0x30,
	...
	testArticleSummary4_d2 = &ptttype.ArticleSummaryRaw{
		Aid: 4,
		FileHeaderRaw: &ptttype.FileHeaderRaw{
			Filename: ptttype.Filename_t{ // M.1607203395.A.F6A
				'.', 'd', 'e', 'l', 'e', 't', 'e', 'd',
